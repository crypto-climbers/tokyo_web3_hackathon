...
export class CowSwap {
    async ethToWeth() {
        ...
        const cowSwapWethGoerli = new ethers.Contract("0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6", COWSWAP_WETH9_ABI, signer);
    ...
    async giveApproval() {
        ...
        const cowSdk = new CowSdk(
            5, {              // Leaving chainId empty will default to MAINNET
            signer: signer  // Provide a signer, so you can sign order
        })

        const erc20 = new ethers.Contract("0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6", ERC20.abi, signer);
    ...
    async swapWethToUsdc() {
        ...
        const { sellToken, buyToken, validTo: validToString, buyAmount, sellAmount, receiver, feeAmount } = quoteResponse.quote;
